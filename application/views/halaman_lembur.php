...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<?php if($this->session->userdata('role')==='1'):?>
			...
			<li class="active"><a href='<?php echo site_url('admin/halamanlembur')?>'><em class='fa fa-align-left'>&nbsp;</em> Lembur/Tunjangan</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Lembur-Tunjangan</h1>
			</div>
		</div>
